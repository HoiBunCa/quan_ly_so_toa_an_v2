...
interface RelatedPartyInfoModalProps {
  initialData: RelatedPartyInfo;
  onSave: (data: RelatedPartyInfo) => void;
  onClose: () => void;
  isSaving: boolean;
}

export default function RelatedPartyInfoModal({ initialData, onSave, onClose, isSaving }: RelatedPartyInfoModalProps) {
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900 flex items-center">
            ...
            Chỉnh sửa Thông tin Người có quyền lợi và nghĩa vụ liên quan
          </h2>
          <button
            onClick={onClose}
