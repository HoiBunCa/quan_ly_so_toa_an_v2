...
export const caseTypes: CaseType[] = [
  {
    ...
    attributes: [
      ...
      { id: 'ngay_chuyen_don_ve_giai_quyet_theo_thu_tuc_to_tung', name: 'Ngày chuyển đơn về giải quyết theo thủ tục tố tụng', type: 'date', required: false, width: 250 },
      ...
      { id: 'so_yeu_cau_sua_doi_bo_sung_don_khoi_kien', name: 'Số yêu cầu sửa đổi bổ sung đơn khởi kiện', type: 'text', required: false, width: 250 },
      { id: 'ngay_yeu_cau_sua_doi_bo_sung_don_khoi_kien', name: 'Ngày yêu cầu sửa đổi bổ sung đơn khởi kiện', type: 'date', required: false, width: 250 },
      ...
      { id: 'so_thong_bao_nop_tam_ung_an_phi', name: 'Số thông báo nộp tạm ứng án phí', type: 'text', required: false, width: 220 },
      { id: 'ngay_thong_bao_nop_tam_ung_an_phi', name: 'Ngày thông báo nộp tạm ứng án phí', type: 'date', required: false, width: 220 },
      { id: 'ngay_nop_tien_tam_ung_an_phi', name: 'Ngày nộp tiền tạm ứng án phí', type: 'date', required: false, width: 200 },
      ...
      { id: 'so_giu_nguyen_viec_tra_lai_don_khoi_kien', name: 'Số giữ nguyên việc trả lại đơn khởi kiện', type: 'text', required: false, width: 250 },
      { id: 'ngay_giu_nguyen_viec_tra_lai_don_khoi_kien', name: 'Ngày giữ nguyên việc trả lại đơn khởi kiện', type: 'date', required: false, width: 250 },
      { id: 'so_nhan_lai_don_khoi_kien_va_tai_lieu', name: 'Số nhận lại đơn khởi kiện và tài liệu', type: 'text', required: false, width: 250 },
      { id: 'ngay_nhan_lai_don_khoi_kien_va_tai_lieu', name: 'Ngày nhận lại đơn khởi kiện và tài liệu', type: 'date', required: false, width: 250 },
      { id: 'so_yeu_cau_toa_an_nhan_lai_don_khoi_kien', name: 'Số yêu cầu toà án nhận lại đơn khởi kiện', type: 'text', required: false, width: 250 },
      { id: 'ngay_yeu_cau_toa_an_nhan_lai_don_khoi_kien', name: 'Ngày yêu cầu toà án nhận lại đơn khởi kiện', type: 'date', required: false, width: 250 },
      { id: 'so_ap_dung_bien_phap_khan_cap_tam_thoi', name: 'Số áp dụng biện pháp khẩn cấp tạm thời', type: 'text', required: false, width: 220 },
      { id: 'ngay_ap_dung_bien_phap_khan_cap_tam_thoi', name: 'Ngày áp dụng biện pháp khẩn cấp tạm thời', type: 'date', required: false, width: 220 },
