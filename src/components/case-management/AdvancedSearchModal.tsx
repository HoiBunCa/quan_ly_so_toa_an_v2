...
export default function AdvancedSearchModal({ onClose, onApplySelection, initialCriteria, book, caseType }: AdvancedSearchModalProps) {
  ...
  const modalTableSettings = {
    ...
    readOnly: true,
    contextMenu: false,
    // height: '250px', // Removed from settings, will be set on container
    stretchH: 'all',
  ...
  // We will now use all columns generated by getHandsontableConfig for HON_NHAN
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-3xl w-full mx-4 flex flex-col max-h-[90vh]">
        ...
        <div className="flex-1 overflow-hidden p-6 pt-0">
          ...
          {isLoadingResults ? (
            ...
            <div className="handsontable-container" style={{ height: '250px' }}> {/* Changed this line */}
